...
always @(*) begin
	...
	{3'b010, 1'b1, 3'0xx}: taken = 1'b1; //BNE
	{3'b011, 1'b1, (3'bx01 || 3'bx10)}: taken = 1'b1; //BLT: if !N=V-> if 0=0 or 1=1
	{3'b100, 1'b1, (3'bx01 || 3'bx10 || 3'b1xx)}: taken = 1'b1; //BLE: if !N=V or Z=1
	default: taken = 1'b0;
